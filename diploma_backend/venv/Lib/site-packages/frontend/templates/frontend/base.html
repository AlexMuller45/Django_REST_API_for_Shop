          ...
          <nav class="row-block">
            <div class="row ControlPanel-rowSplit">
                {% if user.is_authenticated %}
                  ...
                  <div class="row-block"><a class="ControlPanel-title" href="/admin/logout/">Выход</a>
                  </div>
                {% else %}
                  <div class="row-block"><a class="ControlPanel-title" href="/admin/login">Вход</a>
                  </div>
                  <div class="row-block"><a class="ControlPanel-title" href="#">Регистрация</a>
                  </div>
                {% endif %}
        ...
        <div class="Header-categories">
          <div class="CategoriesButton">
            <div class="CategoriesButton-title">
              ...
              </div><span class="CategoriesButton-text">Все разделы</span>
        ...
        <div class="Header-search">
          <div class="search">
            <form class="form form_search"  @submit.prevent="search">
              <input class="search-input" id="query" name="query" type="text" v-model="searchText" placeholder="Чего изволите ..."/>
      ...
      <div class="row Footer-main">
        ...
        <div class="row-block">
          ...
          <ul class="menu menu_vt Footer-menu">
            <li class="menu-item"><a class="menu-link" href="/admin/logout/">Выйти</a>
            </li>
            <li class="menu-item"><a class="menu-link" href="/cart/">Моя корзина</a>
            </li>
            <li class="menu-item"><a class="menu-link" href="#">Доставка</a>
            </li>
            <li class="menu-item"><a class="menu-link" href="order/">Информация о заказе</a>
            </li>
        ...
        <div class="row-block">
          ...
          <ul class="menu menu_vt Footer-menu">
            <li class="menu-item"><a class="menu-link" href="catalog/1">Аксессуары</a>
            </li>
            <li class="menu-item"><a class="menu-link" href="catalog/2">Сумки</a>
            </li>
            <li class="menu-item"><a class="menu-link" href="catalog/3">Камеры</a>
            </li>
            <li class="menu-item"><a class="menu-link" href="catalog/4">Одежда</a>
            </li>
            <li class="menu-item"><a class="menu-link" href="catalog/5">Электроника</a>
            </li>
            <li class="menu-item"><a class="menu-link" href="catalog/6">Стиль</a>
            </li>
          </ul>
        </div>
        <div class="row-block">
    ...
    <div class="Footer-copy">
      <div class="wrap">
        <div class="row row_space">
          ...
          <div class="row-block"><span>Не принимаем к оплате</span>

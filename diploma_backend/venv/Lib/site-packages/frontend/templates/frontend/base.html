        ...
        <nav class="row-block row-block_right Header-menu">
          <div class="menuModal" id="navigate">
            <ul class="menu menu_main">
              ...
              <li class="menu-item"><a class="menu-link" href="catalog.html">Покупки</a>
              </li>
            </ul>
          </div>
        </nav>
      ...
      <div class="row Footer-main">
        ...
        <div class="row-block">
          ...
          <ul class="menu menu_vt Footer-menu">
            <li class="menu-item"><a class="menu-link" href="#">Выйти</a>
            </li>
            <li class="menu-item"><a class="menu-link" href="#">Моя корзина</a>
            </li>
        ...
        <div class="row-block">
          ...
          <ul class="menu menu_vt Footer-menu">
            ...
            <li class="menu-item"><a class="menu-link" href="#">Сумки</a>
            </li>
            ...
            <li class="menu-item"><a class="menu-link" href="#">Стиль</a>
            </li>
          </ul>
        </div>
        <div class="row-block">
          ...
          <p>Phone: 8.800.200.600<br>Email: Support@ninzio.com<br>Skype: techno<br>Адрес: New York, north<br>Avenue 26/7<br>0057
          </p>
        </div>
      </div>
    </div>
